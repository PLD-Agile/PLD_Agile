...
class TestTourService:
    ...
    def setup(self):
        ...
        self.delivery_man = DeliveryManService.instance().create_delivery_man('John Doe')
    ...
    def test_should_add_delivery_request(self):
        ...
        assert len(self.service.tour_requests.value.get(self.delivery_man.id).deliveries) == 1
    ...
    def test_should_add_multiple_delivery_request(self):
        ...
        assert len(self.service.tour_requests.value.get(self.delivery_man.id).deliveries) == 2
    ...
    def test_should_remove_delivery_request(self):
        ...
        delivery_request = self.service.add_delivery_request(Position(1, 1), 0, self.delivery_man.id)
        
        self.service.remove_delivery_request(delivery_request.id, self.delivery_man.id)
        
        assert len(self.service.tour_requests.value.get(self.delivery_man.id).deliveries) == 0
    ...
    def test_should_update_delivery_request_time_window(self):
        ...
        self.service.update_delivery_request_time_window(delivery_request.id, self.delivery_man.id, NEW_TIME_WINDOW)
        
        
        
        assert self.service.tour_requests.value.get(self.delivery_man.id).deliveries.get(delivery_request.id).time_window == NEW_TIME_WINDOW
    ...
    def test_should_update_delivery_request_delivery_man(self):
        ...
        self.service.update_delivery_request_delivery_man(delivery_request.id, self.delivery_man.id, delivery_man_2.id)
        
        assert self.service.tour_requests.value.get(delivery_man_2.id).deliveries.get(delivery_request.id) is not None