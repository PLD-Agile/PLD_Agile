...
class TestMapLoaderService:
    ...
    def root(self):
        ...
        root.append(Element("intersection", attrib={"id": "1", "latitude": "0", "longitude": "0"}))
        root.append(Element("intersection", attrib={"id": "2", "latitude": "0", "longitude": "1"}))
        root.append(Element("intersection", attrib={"id": "3", "latitude": "1", "longitude": "0"}))

        root.append(Element("segment", attrib={"name": "segment1", "origin": "1", "destination": "2", "length": "1.1"}))
        root.append(Element("segment", attrib={"name": "segment2", "origin": "1", "destination": "3", "length": "10.23"}))
